...
!ALL PE subroutine on Ocean!  Due to otpm design the fluxes should be initialized like this on ALL PE's!
  ...
  !  </TEMPLATE>
  ! </SUBROUTINE>
  subroutine ocean_generic_sbc(Ice_ocean_boundary_fluxes,Disd,Djsd, T_prog, runoff, basal, icb)
    ...
    real, intent(in), dimension(Disd:,Djsd:)                        :: icb !Pedro
